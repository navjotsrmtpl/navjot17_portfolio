                ...
                <div className='experience_box'>
                    <div className="border_box_exp">
                        <h3 className='wattmonk'>
                            ...
                            <span style={{ marginLeft: '4px' }}> S & P Global (Market Intelligence)</span>
                            <span>(June 2024 to May Present) </span>
                        </h3>
                        <h4 className='exp_title'>Senior UI Developer</h4>
                        <a className='exp_title' href='https://www.spglobal.com/marketintelligence/en/' target="_blank">https://www.spglobal.com/marketintelligence/en/</a>
                        <div>
                        </div>
                        <div>
                            <p className='exp_title'><strong>Tools and technology Used: </strong> React Js,Next JS, AWS, Azure</p>
                        </div>
                        <div>
                            <p className='exp_title'>
                                <strong>Reponsibilities:</strong>
                                <ul>
                                    <li>Developing end to end UI and Functionalities</li>
                                </ul>
                            </p>
                        </div>
                    </div>
